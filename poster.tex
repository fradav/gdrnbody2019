...
\begin{column}{\colwidth}
  ...
  \begin{block}{A new implementation of Random Forest for ABC}
    ...
    \justifying Ongoing project \realemph{LeafLitter} intends to pursue that line even further: for a growing tree, only encountered leaves are stored. Thus, the memory footprint of trees becomes negligible, and their growing could finally be parallelized at full scale.
